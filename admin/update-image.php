...
if(isset($_POST['submit']))
{
	...
	$sql=mysqli_query($con,"update medicine set image1='$productimage1' where id='$pid' ");
							...
							<div class="module-body">
								...
								<form class="form-horizontal row-fluid" name="insertproduct" method="post"
									...
									<?php 
										...
										$query=mysqli_query($con,"select name,image1,image2,image3 from medicine where id='$pid'");
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="file" name="image1" id="image1" value="" 											class="span8 tip" >
										</div>
									</div>
